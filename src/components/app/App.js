...
import { postsList } from '../../constants'; // donetodo помимо константы postsList достать еще usersList
          ...
          postsList.map((item, index) => {
           ...
           const author = `${first_name} ${last_name}`;
            ...
            //  передать этот массив в Card как пропсу под названиес comments
              ...
              const comments = allComments.filter(comments => item.id === comments.post_id);
